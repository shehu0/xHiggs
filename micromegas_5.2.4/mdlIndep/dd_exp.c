...
//   double dNdEarr[10][RE_DIM];   
   ...
   displayPlot("Xenon1T:  90%% exclusion for light mediator","M[MeV]",pow(10,-0.05) ,1000*medMass*pow(10,-0.05), 1,2 
                ,"MDM=1000 ne events", N, sigma[0], NULL
                ,"MDM=1000  1 event", N, sigma[1], NULL
              );      
