...
double vs1120F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1120T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2200F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs2200T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1100F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1100T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1210F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1210T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1122F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1122T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2211F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs2211T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}

double vs1110F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1110T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2220F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs2220T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1112F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1112T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1222F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1222T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1220F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1220T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2210F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs2210T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs2221F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs2221T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}
double vs1211F(double T){if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  double r= polint3(T,Ntab2,Ttab2,  vs1211T);if(r<log(2*ZeroCS/3.8937966E8)) return 0; else return  3.8937966E8*exp(r);}

//double TCoeffF(double T) { return polint3(T,Ntab,Ttab, TCoeff);}

double dY1F(double T){ if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  return polint1(T,Ntab2,Ttab2, Y1T) ;}
double dY2F(double T){ if(T<Ttab2[Ntab2-1] || T> Ttab2[0]) return sqrt(-1);  return polint1(T,Ntab2,Ttab2, Y2T) ;}
              ...
              {  double  brV1,wV1;
                 ...
                 {   double Pcm0,PcmMax;
                    ...
                    *(cc23->interface->gswidth)=1;  
                    ...
                    buildInterpolation(sigma23, Pcm0,PcmMax, 0.02,1E-2, &(AUX[nsub22].nTab), &(AUX[nsub22].pcmTab), &(AUX[nsub22].csTab));
//displayPlot("sigma23","P", Pcm0,PcmMax,0,1,"sigma23",0,sigma23,NULL );
...
double YF(double T){if(T<Ttab[Ntab-1] || T> Ttab[0]) return sqrt(-1);     return polint3(T,Ntab,Ttab, Ytab) ;}
...
double darkOmegaTR(double Tr, double Yr,  int Fast, double Beps,int *err)
{
  ...
  Ntab=100;
  Ytab=realloc(Ytab,sizeof(double)*Ntab);
...
//printf("L[2]=%e = %e + %e  vs2210=%E   \n", L[2], - y1_*2*vs1122, -vs2210*y2q_y1, vs2210);
  ...
  coef=sqrt(M_PI/45)*MPlanck*sqrt_gStar;
...
//printf("(vs1100=%.2E vs2200=%.2E)  (vs1110=%.2E,vs2220=%.2E)  (vs1120=%.2E,vs2210=%.2E) (vs1210=%.2E,vs1220=%.2E) (vs1112=%.2E,vs2221=%.2E) (vs1122=%.2E vs2211=%.2E) (vs1222=%.2E,vs1211=%.2E)\n",
//vs1100, vs2200,vs1110,vs2220,vs1120,vs2210,vs1210,vs1220,vs1112,vs2221,vs1122, vs2211,vs1222,vs1211);
...
//        TCoeff[i]=sqrt(M_PI/45)*MPlanck*sqrt_gStar;
////        printf("T=%e TCoeff=%E\n", T,TCoeff[i]);
//      }
...
//printf("T=%E ok\n",T);        
  ...
  if(ExcludedFor2DM)
  {
    if(strstr(ExcludedFor2DM,"1110")) {for(i=0;i<N;i++) vs1110T[i]=0; printf("vs1110 ignored\n");}
    if(strstr(ExcludedFor2DM,"2220")) {for(i=0;i<N;i++) vs2220T[i]=0; printf("vs2220 ignored\n");}
    if(strstr(ExcludedFor2DM,"1210")) {for(i=0;i<N;i++) vs1210T[i]=0; printf("vs1210 ignored\n");} 
    if(strstr(ExcludedFor2DM,"1220")) {for(i=0;i<N;i++) vs1220T[i]=0; printf("vs1220 ignored\n");}
    if(strstr(ExcludedFor2DM,"2210")) {for(i=0;i<N;i++) vs2210T[i]=0; printf("vs2210 ignored\n");}
    if(strstr(ExcludedFor2DM,"1122")||strstr(ExcludedFor2DM,"2211")) {for(i=0;i<N;i++) {vs1122T[i]=0;vs2211T[i]=0;}  printf("vs1122&vs2211 ignored\n");} 
    if(strstr(ExcludedFor2DM,"1112")||strstr(ExcludedFor2DM,"1211")) {for(i=0;i<N;i++) {vs1112T[i]=0;vs1211T[i]=0;}  printf("vs1112&vs1211 ignored\n");}
    if(strstr(ExcludedFor2DM,"1222")||strstr(ExcludedFor2DM,"2212")) {for(i=0;i<N;i++) {vs1222T[i]=0;vs2221T[i]=0;}  printf("vs1222&vs2221 ignored\n");}
  }
...
{
  double vs1100,vs2200,vs1110,vs2220,vs1120,vs1122,vs1210,vs2211,vs1112,vs1222,vs1220,vs2210,vs2221,vs1211;
  vs1100 = exp(polint3(T,Ntab2,Ttab2, vs1100T)); 
  vs1120 = exp(polint3(T,Ntab2,Ttab2, vs1120T)); 
  vs1122 = exp(polint3(T,Ntab2,Ttab2, vs1122T)); 
  vs1210 = exp(polint3(T,Ntab2,Ttab2, vs1210T)); 
  vs2200 = exp(polint3(T,Ntab2,Ttab2, vs2200T)); 
  vs2211 = exp(polint3(T,Ntab2,Ttab2, vs2211T)); 
  vs1110 = exp(polint3(T,Ntab2,Ttab2, vs1110T)); 
  vs2220 = exp(polint3(T,Ntab2,Ttab2, vs2220T)); 
  vs1112 = exp(polint3(T,Ntab2,Ttab2, vs1112T)); 
  vs1222 = exp(polint3(T,Ntab2,Ttab2, vs1222T)); 
  vs1220 = exp(polint3(T,Ntab2,Ttab2, vs1220T)); 
  vs2210 = exp(polint3(T,Ntab2,Ttab2, vs2210T)); 
  vs2221 = exp(polint3(T,Ntab2,Ttab2, vs2221T)); 
  vs1211 = exp(polint3(T,Ntab2,Ttab2, vs1211T)); 
...
//Y[1]= 2.362630E-04; 
  ...
  { double h=0.01*Tstart*(1-1/step);
    for(i=1,err=0,T=Tstart; T> Tend && !err;i++ )
    { double T2=T/step;
      double Yscal[2]={fabs(Y[0]),fabs(Y[1])};
//printf("T=%E  Y= %E %E \n",T,Y[0],Y[1]);      
     if(Yscal[0]<Yscal[1]*0.001) Yscal[0]=Yscal[1]*0.001;
     if(Yscal[1]<Yscal[0]*0.001) Yscal[1]=Yscal[0]*0.001; 
...
// i=0; printf("i=%d  T=%E  %E %e\n", i, TR,  Y1T[i]+Yeq1(TR),Y2T[i]+Yeq2(TR));    
